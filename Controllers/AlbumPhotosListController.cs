...
namespace PhotoWEB.Controllers
{
    public class AlbumPhotosListController : Controller
    {
        ...
        public AlbumPhotosListController(IUserRepository _Urepository,IPhotoRepository _PHrepository, IAlbumRepository _Arepository, ICommentRepository _Crepository)
        {
